...
def get_ip_data():
    ...
    input_ip_name = input("what is the name for this IP?")
    #input_color = input("What color is this ip, green red or blue?")
#    while input_color != 'green' or input_color != 'red' or input_color != 'blue':
    input_color = input("what color green red or blue")
 #       try:
  #          print(input_color)
   #     except:
    #        print("invalid color")

    d = {"IP": input_ip, "driver": input_driver, "name": input_ip_name,"color": input_color}
    return d
